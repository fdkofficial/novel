...
import '../../features/profile/presentation/screens/my_novels_screen.dart';
import '../../features/profile/presentation/screens/create_novel_screen.dart';
import '../../features/profile/presentation/screens/edit_novel_screen.dart';
import '../../features/profile/presentation/screens/chapters_screen.dart';
            ...
            routes: [
              ...
              GoRoute(
                ...
                builder: (context, state) {
                  ...
                  return EditNovelScreen(novelId: novelId);
                },
              ),
              GoRoute(
                path: ':novelId/chapters',
                builder: (context, state) {
                  final novelId = state.pathParameters['novelId']!;
                  return ChaptersScreen(novelId: novelId);
                },
              ),
            ],
          ),
